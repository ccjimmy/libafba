...
public final class SeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    //private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/fr.mydedibox.utility";
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
    	...
    	mMinValue = 0;//attrs.getAttributeIntValue(PREFERENCE_NS, ATTR_MIN_VALUE, DEFAULT_MIN_VALUE);
    	mMaxValue = 100;//attrs.getAttributeIntValue(PREFERENCE_NS, ATTR_MAX_VALUE, DEFAULT_MAX_VALUE);
